    ...
    <div className="relative isolate overflow-hidden rounded-3xl border border-gold/45 bg-emerald-dark text-emerald-dark shadow-[0_22px_50px_-30px_oklch(0.1_0.03_166_/_0.95)]">
      ...
      <div className="relative z-20 p-4 sm:p-5">
        <div className="relative max-w-[72%] text-emerald-deep sm:max-w-[69%]">
          <p className="text-[0.75rem] font-extrabold tracking-[0.3em] text-bronze uppercase sm:text-[0.8rem]">
            Tabung Qurban
          </p>

          <h2 className="mt-1 font-serif text-3xl leading-tight font-bold sm:text-4xl xl:text-5xl">
        ...
        <div className="relative z-30 mt-4 rounded-2xl border border-gold/70 bg-emerald-dark/95 p-2.5 text-cream shadow-[0_8px_20px_-10px_oklch(0.1_0.03_166_/_0.9)] sm:mt-5 sm:p-3">
          <div className="flex items-center gap-2 text-[0.75rem] font-extrabold tracking-[0.13em] text-gold uppercase sm:text-[0.8rem]">
          ...
          <div className="mt-2 grid grid-cols-4 divide-x divide-gold/25 rounded-xl border border-gold/20 bg-emerald-deep/60">
            {parts.map((p) => (
              <div key={p.l} className="min-w-0 px-1.5 py-2 text-center sm:px-2">
                <p className="font-mono text-2xl font-black leading-none text-cream sm:text-3xl xl:text-4xl">
                  {p.v}
                </p>

                <p className="mt-1 text-[0.65rem] font-bold tracking-[0.1em] text-gold sm:text-[0.7rem]">
                  {p.l}
                </p>
              </div>
            ))}
          ...
          {[
            ...
            >
              <div className="flex items-start gap-2">
                ...
                <p className="pt-1 text-[0.7rem] font-extrabold leading-tight tracking-[0.06em] text-emerald-deep uppercase">
                  {label}
                </p>
              </div>

              <p className="mt-2 truncate text-xl font-black tracking-tight text-emerald-deep sm:text-2xl xl:text-3xl">
                {value}
              </p>
            </div>
          ))}
        ...
        {hasError && (
          <p className="mt-2 text-[0.75rem] font-semibold text-bronze/80">
        ...
        <div className="relative z-30 mt-3 grid gap-2 rounded-2xl border border-gold/30 bg-cream/80 p-2.5 sm:grid-cols-3 sm:p-3">
          {[
            ...
            {
              Icon: Beef,
              t: "Anggaran harga lembu 1 bahagian pada tahun 2027 adalah RM900.",
            },
          ].map(({ Icon, t }) => (
            <div key={t} className="flex min-w-0 gap-2">
              ...
              <p className="text-[0.75rem] leading-snug text-emerald-deep/85">
                {t}
              </p>
            </div>
          ))}
        ...
        <div className="relative z-30 mt-3 overflow-hidden rounded-2xl border border-gold/70 bg-emerald-dark/95 px-3 py-3 text-cream sm:px-4 sm:py-3.5">
          ...
          <div className="relative flex gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-[0.75rem] leading-relaxed text-cream/85 sm:text-[0.8rem]">
