  ...
  return (
    ...
    >
      <img
        ...
        width={1024}
        height={768}
        className={`absolute inset-y-0 right-0 h-full w-full object-cover object-top transition-transform duration-700 ${
          activity ? "opacity-95 object-[center_top] lg:w-[62%] lg:object-cover" : "opacity-35"
        }`}
      />
      <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(17,58,48,0.98)_0%,rgba(17,58,48,0.93)_37%,rgba(17,58,48,0.54)_68%,rgba(17,58,48,0.18)_100%)]" />
