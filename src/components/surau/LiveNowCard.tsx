...
import quranBackground from "@/assets/system/quran.jpg";
...
export function LiveNowCard({ activity }: { activity: Activity | null }) {
  ...
  return (
    ...
    >
      ...
      />
      <div className="absolute inset-y-0 right-0 w-[58%] bg-gradient-to-l from-emerald-dark/10 via-transparent to-transparent" />
      <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(9,28,23,0.9)_0%,rgba(9,28,23,0.78)_18%,rgba(9,28,23,0.62)_30%,rgba(9,28,23,0.44)_46%,rgba(9,28,23,0.2)_60%,rgba(9,28,23,0.05)_76%,rgba(9,28,23,0)_100%)]" />
      <div className="absolute inset-0 bg-gradient-to-t from-emerald-dark/45 via-transparent to-emerald-dark/5" />
      <img
        src={heroImage}
        alt={activity ? activity.penceramah || activity.tajuk : ""}
        width={1024}
        height={768}
